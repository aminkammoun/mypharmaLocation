...
(function() {
  ...
  function __decorate(a, b, c, d) {
    var e = arguments.length,
      ...
      g;
    g = z.Reflect;
    if ("object" === typeof g && "function" === typeof g.decorate)
      f = g.decorate(a, b, c, d);
    else
      for (var l = a.length - 1; 0 <= l; l--)
        if ((g = a[l])) f = (3 > e ? g(f) : 3 < e ? g(b, c, f) : g(b, c)) || f;
    return 3 < e && f && Object.defineProperty(b, c, f), f;
  }
  function __metadata(a, b) {
    var c = z.Reflect;
    if ("object" === typeof c && "function" === typeof c.metadata)
      return c.metadata(a, b);
  }
  ...
  E.prototype.get = function() {
    var a;
    0 < this.s
      ? (this.s--, (a = this.o), (this.o = a.next), (a.next = null))
      : (a = this.M());
    return a;
  };
  ...
  var N = function(a, b, c) {
      0 == a.b &&
        ...
        (a.b = 1),
        ta(c, a.Y, a.Z, a) ||
          ((a.K = c), (a.b = b), (a.u = null), wa(a), 3 != b || ya(a, c)));
    },
    ta = function(a, b, c, d) {
      if (a instanceof O)
        return (
          null != b && D(b, "opt_onFulfilled should be a function."),
          null != c &&
            D(
              c,
              "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"
            ),
          xa(a, sa(b || r, c || null, d)),
          !0
        );
      var e;
      if (a)
  ...
  Q.prototype.create = function(a, b) {
    ...
    var c =
        void 0 === c
          ? "Error"
          : c.replace(this.pattern, function(a, c) {
              a = b[c];
  ...
  T.prototype.$ = function(a) {
    void 0 !== this.a &&
      ...
      (delete this.a[a],
      --this.J,
      0 === this.J && void 0 !== this.D && this.D(this));
  };
  var U = function(a, b) {
  ...
  X.prototype.delete = function() {
    ...
    return new W(function(b) {
      ...
      .then(function() {
        ...
        return W.all(
          Object.keys(a.i).map(function(b) {
  ...
  X.prototype.R = function(a) {
    Y(this);
    void 0 === this.i[a] &&
      (this.i[a] = this.H.INTERNAL.factories[a](this, this.P.bind(this)));
    return this.i[a];
  };
  ...
  function Ja() {
    ...
    function c(a, b) {
      ...
      a = a.options;
      "auth" === b &&
        (a.serviceAccount || a.credential) &&
        ((c = "serverAuth"), "serverAuth" in e || Z("serverAuthMissing"));
      return c;
    }
    var d = {},
      e = {},
      ...
      g = {
        ...
        initializeApp: function(a, c) {
          void 0 === c
            ? (c = "[DEFAULT]")
            : ("string" === typeof c && "" !== c) ||
              Z("bad-app-name", { name: c + "" });
          void 0 !== d[c] && Z("dupApp", { name: c });
          a = new X(a, c, g);
          d[c] = a;
          b(a, "create");
          (void 0 != a.INTERNAL && void 0 != a.INTERNAL.getToken) ||
            P(a, {
              INTERNAL: {
                getToken: function() {
  ...
  function Ia(a, b) {
    ...
    b = {
      noApp:
        "No Firebase App '" +
        b.name +
        "' has been created - call Firebase App.initializeApp().",
...
(function() {
  ...
  var Da = Array.prototype.indexOf
    ...
    Fa = Array.prototype.map
      ...
      : function(a, b, c) {
          for (
            var d = a.length, e = Array(d), f = n(a) ? a.split("") : a, g = 0;
            g < d;
            g++
          )
  ...
  var eb = y("Opera"),
    ...
    hb =
      y("Gecko") &&
      !(v(Za.toLowerCase(), "webkit") && !y("Edge")) &&
      !(y("Trident") || y("MSIE")) &&
      !y("Edge"),
  ...
  var ob = kb,
    ...
    qb =
      pb && z
        ? jb() || ("CSS1Compat" == pb.compatMode ? parseInt(ob, 10) : 5)
        : void 0;
  var rb = null,
    sb = null,
    ub = function(a) {
  ...
  Fb.prototype.add = function(a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.Bb = !1))
      : ((b = new Db(b, this.src, f, !!d, e)), (b.Bb = c), a.push(b));
    return b;
  };
  Fb.prototype.remove = function(a, b, c, d) {
    ...
    b = Gb(e, b, c, d);
    return -1 < b
      ? (Eb(e[b]), Ka(e, b), 0 == e.length && (delete this.w[a], this.yb--), !0)
      : !1;
  };
  var Hb = function(a, b) {
    var c = b.type;
    c in a.w &&
      La(a.w[c], b) &&
      (Eb(b), 0 == a.w[c].length && (delete a.w[c], a.yb--));
  };
  ...
  var Ib = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    Lb = function(a, b, c, d, e) {
      if (ea(b)) for (var f = 0; f < b.length; f++) Lb(a, b[f], c, d, e);
      else
        (c = Mb(c)), a && a[Bb] ? a.listen(b, c, d, e) : Nb(a, b, c, !1, d, e);
    },
    ...
    Sb = function(a, b, c, d, e) {
      if (ea(b)) for (var f = 0; f < b.length; f++) Sb(a, b[f], c, d, e);
      else (c = Mb(c)), a && a[Bb] ? Tb(a, b, c, d, e) : Nb(a, b, c, !0, d, e);
    },
    Ub = function(a, b, c, d, e) {
      if (ea(b)) for (var f = 0; f < b.length; f++) Ub(a, b[f], c, d, e);
      else
        (c = Mb(c)),
          a && a[Bb]
            ? a.Y.remove(String(b), c, d, e)
            : a && (a = Ob(a)) && (b = a.uc(b, c, !!d, e)) && Vb(b);
    },
    Vb = function(a) {
      ...
      b.removeEventListener
        ? b.removeEventListener(c, d, a.Cb)
        : b.detachEvent && b.detachEvent(Qb(c), d);
      Kb--;
      (c = Ob(b))
        ? (Hb(c, a), 0 == c.yb && ((c.src = null), (b[Ib] = null)))
        : Eb(a);
    },
    Qb = function(a) {
      ...
      if (!wb) {
        ...
        if (!(0 > d.keyCode || void 0 != d.returnValue)) {
          ...
          for (e = 0; !b.Va && e < d.length; e++)
            (b.currentTarget = d[e]), (f = Xb(d[e], a, !1, b)), (c = c && f);
        }
        return c;
      }
        ...
        if ("object" == typeof b) {
          if (ea(b)) {
            ...
            for (var e = "", f = 0; f < b; f++)
              c.push(e),
                (e = d[f]),
                jc(a, a.ac ? a.ac.call(d, String(f), e) : e, c),
                (e = ",");
            c.push("]");
            return;
          }
  ...
  var C = function(a, b) {
    ...
    zc = function(a, b) {
      ...
      for (var c = F(Math.pow(b, 8)), d = D, e = 0; e < a.length; e += 8) {
        ...
        8 > f
          ? ((f = F(Math.pow(b, f))), (d = d.multiply(f).add(F(g))))
          : ((d = d.multiply(c)), (d = d.add(F(g))));
      }
      return d;
    },
    D = yc(0),
  ...
  C.prototype.add = function(a) {
    for (
      var b = Math.max(this.h.length, a.h.length), c = [], d = 0, e = 0;
      e <= b;
      e++
    ) {
  ...
  C.prototype.multiply = function(a) {
    ...
    if (-1 == this.g)
      return -1 == a.g ? E(this).multiply(E(a)) : E(E(this).multiply(a));
  ...
  var Gc = function(a, b) {
    ...
    Ec = function(a, b) {
      ...
      for (c = D; 0 <= a.compare(b); ) {
        d = Math.max(1, Math.floor(Cc(a) / Cc(b)));
        e = Math.ceil(Math.log(d) / Math.LN2);
        e = 48 >= e ? 1 : Math.pow(2, e - 48);
        f = F(d);
        for (var g = f.multiply(b); -1 == g.g || 0 < g.compare(a); )
          (d -= e), (f = F(d)), (g = f.multiply(b));
        G(f) && (f = Ac);
        c = c.add(f);
        a = Fc(a, g);
      }
  ...
  C.prototype.shiftLeft = function(a) {
    ...
    for (var c = this.h.length + b + (0 < a ? 1 : 0), d = [], e = 0; e < c; e++)
      d[e] =
        0 < a
          ? (H(this, e - b) << a) | (H(this, e - b - 1) >>> (32 - a))
          : H(this, e - b);
  ...
  var Hc = function(a, b) {
    var c = b >> 5;
    b %= 32;
    for (var d = a.h.length - c, e = [], f = 0; f < d; f++)
      e[f] =
        0 < b
          ? (H(a, f + c) >>> b) | (H(a, f + c + 1) << (32 - b))
          : H(a, f + c);
    return new C(e, a.g);
  };
  var Jc = function(a, b) {
  ...
  var Mc = function(a) {
    ...
    Lc = function(a) {
      var b = D;
      if (a instanceof C) {
        if (0 != a.g || 0 > a.compare(D) || 0 < a.compare(Nc))
        ...
        for (var d = 0; d < c.length; d++) {
          ...
          if (
            ...
            0 > e ||
            255 < e ||
            (1 != c[d].length && 0 == c[d].lastIndexOf("0", 0))
          )
  ...
  Lc.prototype.toString = function() {
    ...
    for (var a = Dc(this.pb, 0), b = [], c = 3; 0 <= c; c--)
  ...
  var Kc = function(a) {
    var b = D;
    if (a instanceof C) {
      if (0 != a.g || 0 > a.compare(D) || 0 < a.compare(Pc))
      ...
      for (d = 0; d < c.length; d++) {
        e = zc(c[d], 16);
        if (0 > e.compare(D) || 0 < e.compare(Rc))
  ...
  Zc.prototype.get = function() {
    var a;
    0 < this.Sb
      ? (this.Sb--, (a = this.Lb), (this.Lb = a.next), (a.next = null))
      : (a = this.Td());
    return a;
  };
  ...
  cd.prototype.remove = function() {
    ...
    this.Ja &&
      ((a = this.Ja),
      (this.Ja = this.Ja.next),
      this.Ja || (this.kc = null),
      (a.next = null));
    return a;
  };
  var dd = function() {
  ...
  var yd = function(a, b) {
      if (0 == a.F)
        if (a.o) {
          ...
          if (c.fa) {
            for (
              var d = 0, e = null, f = null, g = c.fa;
              g && (g.ib || (d++, g.child == a && (e = g), !(e && 1 < d)));
              g = g.next
            )
              e || (f = g);
            e &&
  ...
  var nd = function(a, b, c) {
      0 == a.F &&
        ...
        sd(c, a.He, a.Ie, a) ||
          ...
          (a.o = null),
          Bd(a),
          3 != b || c instanceof od || Cd(a, c)));
    },
    sd = function(a, b, c, d) {
      if (a instanceof I)
        return (
          null != b && Ca(b, "opt_onFulfilled should be a function."),
          null != c &&
            Ca(
              c,
              "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"
            ),
          wd(a, rd(b || ba, c || null, d)),
          !0
        );
...
*/
  ...
  var Sd = function(a) {
    ...
    Kd = function(a) {
      ...
      for (var b = a.ka, d = (c = !1); a.bc.length && !a.nc; ) {
        ...
        if ((f = a.nb ? g : f))
          try {
            ...
            void 0 !== k &&
              ((a.nb = a.nb && (k == b || k instanceof Error)), (a.ka = b = k));
            if (
              md(b) ||
              ("function" === typeof l.Promise && b instanceof l.Promise)
            )
              (d = !0), (a.nc = !0);
          } catch (q) {
            (b = q), (a.nb = !0), Sd(a) || (c = !0);
      ...
      d &&
        ((k = r(a.Yc, a, !0)),
        (d = r(a.Yc, a, !1)),
        b instanceof Gd ? (Qd(b, k, d), (b.Sc = !0)) : b.then(k, d));
  ...
  var Ud = function(a) {
    this.ob = l.setTimeout(r(this.Ge, this), 0);
    this.J = a;
  };
  Ud.prototype.Ge = function() {
    w(Td[this.ob], "Cannot throw an error that is not scheduled.");
    delete Td[this.ob];
    throw this.J;
  };
  var Td = {};
  var Od = function(a) {
    ...
    Vd = function(a) {
      var b = {},
        ...
        d;
      a instanceof Tc && a.constructor === Tc && a.Nd === Sc
        ? (d = a.Wb)
        : (za(
      ...
      0 < k &&
        ((g = window.setTimeout(function() {
          Xd(e, !0);
          Hd(f, new Yd(1, "Timeout reached for loading script " + d));
        }, k)),
        (a.xb = g));
  ...
  h.dispatchEvent = function(a) {
    ...
    var e = !0,
      f;
    if (b)
      for (var g = b.length - 1; !a.Va && 0 <= g; g--)
        (f = a.currentTarget = b[g]), (e = be(f, d, !0, a) && e);
    a.Va ||
      ((f = a.currentTarget = c),
      (e = be(f, d, !0, a) && e),
      a.Va || (e = be(f, d, !1, a) && e));
    if (b)
      for (g = 0; !a.Va && g < b.length; g++)
        (f = a.currentTarget = b[g]), (e = be(f, d, !1, a) && e);
    return e;
  };
  h.Oa = function() {
    $d.Pc.Oa.call(this);
  ...
  ee.prototype.remove = function(a) {
    return ge(this.Z, a)
      ? (delete this.Z[a],
        this.i--,
        this.na++,
        this.s.length > 2 * this.i && fe(this),
        !0)
      : !1;
  };
  var fe = function(a) {
    ...
    if (a.i != a.s.length) {
      for (var e = {}, c = (b = 0); b < a.s.length; )
        (d = a.s[b]), ge(e, d) || ((a.s[c++] = d), (e[d] = 1)), b++;
      a.s.length = c;
    }
  };
  h = ee.prototype;
  ...
  h.set = function(a, b) {
    ge(this.Z, a) || (this.i++, this.s.push(a), this.na++);
    this.Z[a] = b;
  };
  h.addAll = function(a) {
    var b;
  ...
  var ie = function(a) {
    ...
    ke = function(a, b) {
      if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);
        ...
        for (var c = je(a), d = ie(a), e = d.length, f = 0; f < e; f++)
  ...
  M.prototype.send = function(a, b, c, d) {
    ...
    this.xe &&
      ...
      ((this.a.onprogress = r(function(a) {
        this.pd(a, !0);
      }, this)),
      this.a.upload && (this.a.upload.onprogress = r(this.pd, this)));
    try {
      ...
      L(this.P, Ee(this, "Error opening Xhr: " + f.message));
      this.J(5, f);
      return;
    }
    a = c || "";
    ...
    "withCredentials" in this.a &&
      this.a.withCredentials !== this.Gd &&
      (this.a.withCredentials = this.Gd);
    try {
      Fe(this),
        0 < this.fb &&
          ...
          this.jc
            ? ((this.a.timeout = this.fb),
              (this.a.ontimeout = r(this.xb, this)))
            : (this.hc = we(this.xb, this.fb, this))),
        L(this.P, Ee(this, "Sending request")),
        (this.Ob = !0),
        this.a.send(a),
        (this.Ob = !1);
    } catch (f) {
  ...
  M.prototype.xb = function() {
    "undefined" != typeof aa &&
      this.a &&
      ((this.qb = "Timed out after " + this.fb + "ms, aborting"),
      L(this.P, Ee(this, this.qb)),
  ...
  var He = function(a) {
    a.rc ||
      ((a.rc = !0), a.dispatchEvent("complete"), a.dispatchEvent("error"));
  };
  M.prototype.abort = function() {
    this.a &&
      this.pa &&
      (L(this.P, Ee(this, "Aborting")),
      (this.pa = !1),
      (this.Ba = !0),
      this.a.abort(),
      (this.Ba = !1),
  ...
  M.prototype.Oa = function() {
    this.a &&
      (this.pa &&
        ((this.pa = !1), (this.Ba = !0), this.a.abort(), (this.Ba = !1)),
      Ie(this, !0));
    M.Pc.Oa.call(this);
  };
  ...
  var Je = function(a) {
    if (a.pa && "undefined" != typeof aa)
      if (a.lc[1] && 4 == Ke(a) && 2 == Le(a))
        L(a.P, Ee(a, "Local request error detected and ignored"));
  ...
  var Oe = function(a, b) {
    ...
    a instanceof Oe
      ...
      ? ((this.M = !!b),
        ...
        N(this),
        (this.Aa = Ue(a)))
      : ((this.M = !!b), (this.aa = new O(null, 0, this.M)));
  };
  Oe.prototype.toString = function() {
    var a = [],
      b = this.la;
    ...
    if ((c = this.ra))
      this.ga && "/" != c.charAt(0) && a.push("/"),
        a.push(Ve(c, "/" == c.charAt(0) ? Xe : Ye, !0));
  ...
  Oe.prototype.resolve = function(a) {
    ...
    if (c) Re(b, a.Ua);
      ...
      if (".." == e || "." == e) d = "";
        ...
        for (
          var d = 0 == e.lastIndexOf("/", 0), e = e.split("/"), f = [], g = 0;
          g < e.length;
  ...
  h.remove = function(a) {
    ...
    return this.j.jb(a)
      ? ((this.I = null),
        (this.i = Aa(this.i) - this.j.get(a).length),
        this.j.remove(a))
      : !1;
  };
  h.jb = function(a) {
  ...
  var ef = function(a, b, c) {
    a.remove(b);
    0 < c.length &&
      ((a.I = null), a.j.set(a.K(b), Pa(c)), (a.i = Aa(a.i) + c.length));
  };
  ...
  var hf = function() {
    ...
    of = function(a, b, c) {
      ...
      b =
        c instanceof B
          ? c
          : gc("undefined" != typeof c.href ? c.href : String(c));
      c = d.target || c.target;
      e = [];
      for (g in d)
        switch (g) {
      ...
      "_self" != c
        ? ((g = a.document.createElement("A")),
          "undefined" != typeof HTMLAnchorElement &&
            ...
            ((e =
              g &&
              (g instanceof HTMLAnchorElement ||
                !(g instanceof Location || g instanceof Element))),
            (f = ha(g)
              ? g.constructor.displayName ||
                g.constructor.name ||
        ...
        ? ((g = a.open("", c, g)),
          (d = dc(b)),
          g &&
            (gb && v(d, ";") && (d = "'" + d.replace(/'/g, "%27") + "'"),
            (g.opener = null),
            (a = new ac()),
            (a.fc = "b/12014412, meta tag with sanitized URL"),
            va.test(d) &&
              (-1 != d.indexOf("&") && (d = d.replace(oa, "&amp;")),
              -1 != d.indexOf("<") && (d = d.replace(pa, "&lt;")),
              -1 != d.indexOf(">") && (d = d.replace(qa, "&gt;")),
              -1 != d.indexOf('"') && (d = d.replace(sa, "&quot;")),
              -1 != d.indexOf("'") && (d = d.replace(ta, "&#39;")),
              -1 != d.indexOf("\x00") && (d = d.replace(ua, "&#0;"))),
            (d = '<META HTTP-EQUIV="refresh" content="0; url=' + d + '">'),
            Ba(bc(a), "must provide justification"),
            w(
              !/^[\s\xa0]*$/.test(bc(a)),
              "must provide non-empty justification"
            ),
            g.document.write(Wc(new Vc().ne(d))),
            g.document.close()))
        : (g = a.open(dc(b), c, g));
      if (g)
        try {
    ...
    wf = function() {
      ...
      if (
        !(a =
          !l.location ||
          !l.location.protocol ||
          ("http:" != l.location.protocol && "https:" != l.location.protocol) ||
          sf())
      ) {
        var b;
        a: {
    ...
    xf = function(a) {
      ...
      return b.match(/android/) ||
        b.match(/webos/) ||
        b.match(/iphone|ipad|ipod/) ||
        b.match(/blackberry/) ||
  ...
  var Gf = {
      Hd: { ub: 500, tb: 600, providerId: "facebook.com" },
      Id: { ub: 500, tb: 620, providerId: "github.com" },
      Jd: { ub: 515, tb: 680, providerId: "google.com" },
      Od: { ub: 485, tb: 705, providerId: "twitter.com" }
    },
    Hf = function(a) {
  ...
  var Mf = function(a, b, c, d) {
    ...
    ha(c)
      ? (e = c)
      : b && n(c) && n(d)
      ? (e = { oauthToken: c, oauthTokenSecret: d })
      : !b && n(c) && (e = { accessToken: c });
    if (b || (!e.idToken && !e.accessToken))
      if (b && e.oauthToken && e.oauthTokenSecret)
        Q(this, "accessToken", e.oauthToken),
          Q(this, "secret", e.oauthTokenSecret);
      else {
        if (b)
          throw new R(
            "argument-error",
      ...
      e.idToken && Q(this, "idToken", e.idToken),
        e.accessToken && Q(this, "accessToken", e.accessToken);
    Q(this, "provider", a);
  };
  ...
  var Qf = function(a, b) {
      ...
      c ||
        (b.prototype.addScope = function(a) {
  ...
  Tf.credential = function(a, b) {
    ...
    return new Mf(
      "google.com",
      !1,
      ha(a) ? a : { idToken: a || null, accessToken: b || null }
    );
  };
  ...
  var bg = function(a) {
    if (a.code) {
      ...
      return a.email
        ? new ag(b, a.email, $f(a), a.message)
        : new R(b, a.message || void 0);
    }
    return null;
  };
  var cg = function(a) {
  ...
  var T = function(a, b, c) {
      ...
      this.ae = a.firebaseTimeout || 1e4;
      this.cd = Wa(a.firebaseHeaders || eg);
      c &&
        ((this.cd["X-Client-Version"] = c), (this.wd["X-Client-Version"] = c));
      this.Sd = new uc();
      this.Ke = new cg(d);
    },
    fg,
  ...
  var jg = function(a, b) {
      return new I(function(c, d) {
        ...
        ("authorization_code" == b.grant_type && b.code)
          ? hg(
              a,
              a.Ae + "?key=" + encodeURIComponent(a.v),
              function(a) {
                a
                  ? a.error
                    ? d(ig(a))
          ...
          function(a) {
            a
              ? a.error
                ? e(ig(a))
                : b(a)
              : e(new R("network-request-failed"));
          },
          c,
          kg(d),
          a.cd,
  ...
  var zg = function(a, b, c) {
    ...
    Bg = function(a) {
      var b = null;
      a.needConfirmation
        ? ((a.code = "account-exists-with-different-credential"), (b = bg(a)))
        : "FEDERATED_USER_ID_ALREADY_LINKED" == a.errorMessage
        ? ((a.code = "credential-already-in-use"), (b = bg(a)))
        : "EMAIL_EXISTS" == a.errorMessage &&
          ((a.code = "email-already-in-use"), (b = bg(a)));
      if (b) throw b;
      if (!a.idToken) throw new R("internal-error");
    },
    Nf = function(a, b) {
  ...
  var Hg = { endpoint: "setAccountInfo", D: Eg, cb: "email" },
    ...
    S = function(a, b, c) {
      ...
      return J(c)
        .then(b.D)
        .then(function() {
          b.ua && (c.returnSecureToken = !0);
          return lg(a, b.endpoint, d, c, b.Rd || !1);
        })
        .then(function(a) {
          return (e = a);
        })
  ...
  var Qg = function(a) {
      ...
      b.R.url = a.Je;
      b.R.messageHandlersFilter = uf(
        "gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"
      );
      b.R.attributes = b.R.attributes || {};
      new Mg(b.R.attributes).zd({
        position: "absolute",
        top: "-100px",
        width: "1px",
        height: "1px"
    ...
    Sg = function(a, b) {
      a.od.then(function() {
        a.wc.register(
          "authEvent",
          b,
          uf("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER")
        );
      });
    },
      ...
      return new I(function(a, b) {
        ...
        uf("gapi.iframes.Iframe")
          ...
          : ((l[Tg] = function() {
            ...
            J(Od("https://apis.google.com/js/api.js?onload=" + Tg)).l(
              function() {
                b(Error("Network Error"));
              }
            ));
    ...
    return xd(
      hh(this)
        .then(function(d) {
          b = !0;
          c.sb++;
          return kh(ih(c, jh(c, d, !0))["delete"](a));
        })
        .then(function() {
          delete c.O[a];
        }),
        ...
        a: {
          ...
          if (e.length < k || q < e.length)
            ...
            for (k = 0; k < e.length; k++)
              if (
                ((q = c[k].optional && void 0 === e[k]), !c[k].da(e[k]) && !q)
              ) {
                e = c[k];
                if (0 > k || k >= qh.length)
                  throw new R(
    ...
    Ch = function() {
      Bh ||
        (Bh = new Ah(
          "firebase",
          ":",
          "Safari" == lf(gf()) && l.window && l.window != l.window.top
            ? !0
            : !1,
          xf()
        ));
  ...
  Ah.prototype.Bd = function(a) {
    if (a && a.ce) {
      ...
      if (this.ze) {
        ...
        a != c &&
          (a
            ? l.localStorage.setItem(b, a)
            : a || l.localStorage.removeItem(b));
      }
  ...
  var Nh = function(a) {
    ...
    Oh = function(a) {
      a.Pb ||
        ((a.Pb = !0),
        qf().then(function() {
          a.Mb = new Vg(a.X, a.v, a.ea, a.xa);
          a.Mb.Bc().l(function() {
            a.$b(new R("network-request-failed"));
            a.reset();
          });
          a.Mb.zb.push(a.Rc);
        }));
      ...
      var b = this,
        c = function() {
          ...
          (c = xf(a)) ||
            ((a = a || gf()),
            (c =
              "Safari" == lf(a) || a.toLowerCase().match(/iphone|ipad|ipod/)
                ? !1
                : !0));
          c ? Ph(b.Wa) : Oh(b);
        };
  ...
  var Rh = function(a, b, c, d, e, f) {
      ...
      return a.qa
        ...
        .l(function(b) {
          "auth/network-request-failed" == b.code && (a.qa = null);
          throw b;
        });
    },
    Sh = function(a, b, c, d) {
  ...
  Kh.prototype.sd = function(a, b) {
    ...
    var c = a.va,
      d = a.za;
    "unknown" == c
      ? (this.W || Wh(this, !1, null, null), (a = J()))
      : (a = a.J
          ? this.Gc(a, b)
          : b.mb(c, d)
          ? this.Hc(a, b)
          : K(new R("invalid-auth-event")));
    return a;
  };
  var Ph = function(a) {
  ...
  Kh.prototype.Gc = function(a) {
    this.W || Wh(this, !0, null, a.getError());
    return J();
  };
  ...
  Lh.prototype.Gc = function(a, b) {
    b.Ha(a.va, null, a.getError(), a.za);
    return J();
  };
  ...
  Yh.prototype.getToken = function(a) {
    a = !!a;
    return bi(this)
      ? K(new R("user-token-expired"))
      : a || !this.wa || la() > this.Pa - 3e4
      ? this.S
        ? ai(this, { grant_type: "refresh_token", refresh_token: this.S })
        : J(null)
      : J({
          accessToken: this.wa,
          expirationTime: this.Pa,
  ...
  var pi = function(a) {
    return a.getToken().then(function(b) {
      ...
      return qi(a, b)
        .then(function() {
          c || oi(a, "isAnonymous", !1);
          return b;
        })
        .l(function(b) {
          "auth/user-token-expired" == b.code &&
            (a.dispatchEvent(new di("userDeleted")), ri(a));
          throw b;
        });
    });
  };
    ...
    return ki(this)
      ...
      .l(function(a) {
        if ("auth/user-token-expired" == a.code && !c)
          return hi(b).then(function() {
            oi(b, "refreshToken", null);
            throw a;
          });
        throw a;
      });
  ...
  var si = function(a, b) {
    b.idToken &&
      a.kd != b.idToken &&
      ($h(a.ba, b), a.Da(), ei(a, b.idToken), oi(a, "refreshToken", a.ba.S));
  };
  ...
  h.unlink = function(a) {
    var b = this;
    return this.c(
      pi(this).then(function(c) {
        return Ja(li(b), a)
          ? zg(b.f, c, [a]).then(function(a) {
              var c = {};
  ...
  h.Wc = function(a, b) {
    return ("linkViaPopup" == a && (this.ia || null) == b && this.$) ||
      ("linkViaRedirect" == a && (this.Yb || null) == b)
      ? !0
      : !1;
  };
  h.Ha = function(a, b, c, d) {
    "linkViaPopup" == a &&
      d == (this.ia || null) &&
      (c && this.Fa ? this.Fa(c) : b && !c && this.$ && this.$(b),
  ...
  h.linkWithRedirect = function(a) {
    ...
    var b = this,
      ...
      e = ui(this, a.providerId)
        ...
        .then(function(a) {
          b.Ga && ((a = b.Ga), (a = a.A.set(wi, b.G(), a.B)));
          return a;
        })
        .then(function() {
  ...
  var Y = function(a) {
    ...
    if (X(this).options && X(this).options.apiKey)
      (a = firebase.SDK_VERSION ? tf(firebase.SDK_VERSION) : null),
        (this.f = new T(X(this).options && X(this).options.apiKey, null, a));
  ...
  var Li = function(a) {
    ...
    Ki = function(a) {
      ...
      b &&
        wf() &&
        (a.Wd = a.Ab.then(function() {
          if (!a.Na)
            return (
              (a.m = Vh(b, c, X(a).name)),
              a.m.subscribe(a),
              Z(a) && ii(Z(a)),
              a.Kc && (ii(a.Kc), (a.Kc = null)),
              a.m
            );
        }));
    };
  ...
  h.mb = function(a, b) {
    return "signInViaRedirect" == a ||
      ("signInViaPopup" == a && this.ia == b && this.$)
      ? r(this.Zd, this)
      : null;
  };
  h.Zd = function(a, b) {
  ...
  h.signInWithPopup = function(a) {
    ...
    var b = this,
      ...
      e = null;
    !xf() &&
      X(this).options.authDomain &&
      a.isOAuthProvider &&
      (e = Wg(
        X(this).options.authDomain,
        X(this).options.apiKey,
        X(this).name,
        "signInViaPopup",
        a.providerId,
        a.Hb(),
  ...
  var Mi = function(a, b) {
    ...
    Hi = function(a, b) {
      Z(a) &&
        (gi(Z(a), a.Dd),
        Ub(Z(a), "tokenChanged", a.Ed),
        Ub(Z(a), "userDeleted", a.Cd));
      b &&
        (b.dc.push(a.Dd),
        Lb(b, "tokenChanged", a.Ed),
        Lb(b, "userDeleted", a.Cd));
      Q(a, "currentUser", b);
    };
  ...
  V(Tf, "credential", Tf.credential, [
    wh(U(), wh(rh(), th()), "idToken"),
    wh(U(), th(), "accessToken", !0)
  ]);
...
(function() {
      ...
      case "object":
        ...
        if (da(b)) {
          ...
          for (var e = "", f = 0; f < d; f++)
            c.push(e),
              (e = b[f]),
              ya(a, a.Fd ? a.Fd.call(b, String(f), e) : e, c),
              (e = ",");
          c.push("]");
          break;
        }
  ...
  var Ra = -1 != v.indexOf("Opera") || -1 != v.indexOf("OPR"),
    ...
    Ta =
      -1 != v.indexOf("Gecko") &&
      -1 == v.toLowerCase().indexOf("webkit") &&
      !(-1 != v.indexOf("Trident") || -1 != v.indexOf("MSIE")),
  ...
  (function() {
    ...
    b && (a = (a = b.exec(v)) ? a[1] : "");
    return Sa &&
      ((b = (b = n.document) ? b.documentMode : void 0), b > parseFloat(a))
      ? String(b)
      : a;
  })();
  function Va(a) {
      ...
      if (a.Ha) {
        ...
        if (c.Ca) {
          ...
          0 <= e &&
            (c.L == fb && 1 == d
              ? mb(c, b)
              : ((d = c.Ca.splice(e, 1)[0]), nb(c, d, kb, b)));
        }
        a.Ha = null;
      } else hb(a, kb, b);
  }
  function ob(a, b) {
    (a.Ca && a.Ca.length) || (a.L != ib && a.L != kb) || pb(a);
    a.Ca || (a.Ca = []);
    a.Ca.push(b);
  }
  function lb(a, b, c, d) {
    var e = { m: null, hf: null, kf: null };
    e.m = new eb(function(a, h) {
      e.hf = b
        ? function(c) {
            try {
              var e = b.call(d, c);
  ...
  function hb(a, b, c) {
    if (a.L == fb) {
      if (a == c)
        (b = kb), (c = new TypeError("Promise cannot resolve to itself"));
      else {
        var d;
        if (c)
          try {
  ...
  function Ab(a, b, c) {
    ...
    b = a.N[0];
    c = a.N[1];
    for (var h = a.N[2], k = a.N[3], m = a.N[4], l, e = 0; 80 > e; e++)
      40 > e
        ? 20 > e
          ? ((f = k ^ (c & (h ^ k))), (l = 1518500249))
          : ((f = c ^ h ^ k), (l = 1859775393))
        : 60 > e
        ? ((f = (c & h) | (k & (c | h))), (l = 2400959708))
        : ((f = c ^ h ^ k), (l = 3395469782)),
        (f = (((b << 5) | (b >>> 27)) + f + m + l + d[e]) & 4294967295),
        (m = k),
        (k = h),
  ...
  function y(a, b, c, d) {
    if ((!d || p(c)) && !ga(c))
      throw Error(Bb(a, b, d) + "must be a valid function.");
  }
  function Cb(a, b, c) {
    if (p(c) && (!ha(c) || null === c))
      throw Error(Bb(a, b, !0) + "must be a valid context object.");
  }
  var Db = n.Promise || eb;
  ...
  function Nb(a) {
    for (var b = [], c = 0, d = 0; d < a.length; d++) {
      ...
      55296 <= e &&
        ...
        ((e -= 55296),
        d++,
        Lb(d < a.length, "Surrogate pair missing trail surrogate."),
  ...
  Zb.prototype.Nc = function() {
    return this.path.e()
      ? new Zb(this.source, C)
      : new Zb(this.source, D(this.path));
  };
  ...
  ac.prototype.Nc = function(a) {
    return this.path.e()
      ? new ac(this.source, C, this.Ja.R(a))
      : new ac(this.source, D(this.path), this.Ja);
  };
  ac.prototype.toString = function() {
    return (
      "Operation(" +
  ...
  function dc(a, b) {
    b !== a.bb &&
      ((a.bb = b),
      "s-" === a.bb.substr(0, 2) && Xb.set("host:" + a.host, a.bb));
  }
  function ec(a, b, c) {
    E("string" === typeof b, "typeof type must == string");
    E("object" === typeof c, "typeof params must == object");
    if ("websocket" === b) b = (a.Sc ? "wss://" : "ws://") + a.bb + "/.ws?";
    else if ("long_polling" === b)
  ...
  g.Ra = function(a, b) {
    return new Ac(
      this.Oa,
      this.ca.Ra(a, b, this.Oa).Y(null, null, !1, null, null)
    );
  };
  g.remove = function(a) {
    return new Ac(
      this.Oa,
      this.ca.remove(a, this.Oa).Y(null, null, !1, null, null)
    );
  };
  g.get = function(a) {
  ...
  function K(a) {
    ...
    if (a.le) for (b = b.left; !b.e(); ) a.Sa.push(b), (b = b.right);
    else for (b = b.right; !b.e(); ) a.Sa.push(b), (b = b.left);
    return c;
  }
  function Ec(a) {
    if (0 === a.Sa.length) return null;
  ...
  g.Ra = function(a, b, c) {
    ...
    e =
      0 > d
        ? e.Y(null, null, null, e.left.Ra(a, b, c), null)
        : 0 === d
        ? e.Y(null, b, null, null, null)
        : e.Y(null, null, null, null, e.right.Ra(a, b, c));
    return Hc(e);
  };
  function Ic(a) {
  ...
  g.remove = function(a, b) {
    ...
    c = this;
    if (0 > b(a, c.key))
      c.left.e() || c.left.fa() || c.left.left.fa() || (c = Jc(c)),
        (c = c.Y(null, null, null, c.left.remove(a, b), null));
    else {
      c.left.fa() && (c = Kc(c));
      c.right.e() ||
        c.right.fa() ||
        c.right.left.fa() ||
        ((c = Lc(c)), c.left.left.fa() && ((c = Kc(c)), (c = Lc(c))));
      if (0 === b(a, c.key)) {
  ...
  function Jc(a) {
    a = Lc(a);
    a.right.left.fa() &&
      ((a = a.Y(null, null, null, null, Kc(a.right))),
      (a = Mc(a)),
      (a = Lc(a)));
    return a;
  }
  function Mc(a) {
    return a.right.Y(
      ...
      null,
      a.color,
      a.Y(null, null, !0, null, a.right.left),
      null
    );
  }
  function Kc(a) {
    return a.left.Y(
      ...
      a.color,
      null,
      a.Y(null, null, !0, a.left.right, null)
    );
  }
  function Lc(a) {
    return a.Y(
      ...
      null,
      !a.color,
      a.left.Y(null, null, !a.left.color, null, null),
      a.right.Y(null, null, !a.right.color, null, null)
    );
  }
  function Nc() {}
  g = Nc.prototype;
    ...
    !0 === a
      ? ("undefined" !== typeof console &&
          ("function" === typeof console.log
            ? (wc = r(console.log, console))
            : "object" === typeof console.log &&
              (wc = function(a) {
                console.log(a);
              })),
        b && Yb.set("logging_enabled", !0))
      : ga(a)
      ? (wc = a)
      : ((wc = null), Yb.remove("logging_enabled"));
  }
  function I(a) {
    !0 === Tc &&
      ((Tc = !1), null === wc && !0 === Yb.get("logging_enabled") && Uc(!0));
    if (wc) {
  ...
  function Zc(a) {
    return (
      fa(a) &&
      (a != a || a == Number.POSITIVE_INFINITY || a == Number.NEGATIVE_INFINITY)
    );
  }
  function $c(a) {
  ...
  function gd(a) {
    ...
    0 === a
      ...
      : ((b = 0 > a),
        (a = Math.abs(a)),
        a >= Math.pow(2, -1022)
          ? ((d = Math.min(Math.floor(Math.log(a) / Math.LN2), 1023)),
            (c = d + 1023),
            (d = Math.round(a * Math.pow(2, 52 - d) - Math.pow(2, 52))))
  ...
  var hd = /^-?\d{1,10}$/;
  function bd(a) {
    return hd.test(a) && ((a = Number(a)), -2147483648 <= a && 2147483647 >= a)
      ? a
      : null;
  }
  function Tb(a) {
    try {
      ...
      setTimeout(function() {
        L("Exception was thrown by user callback.", b.stack || "");
        throw b;
      }, Math.floor(0));
    }
  }
  ...
  md.prototype.Nc = function(a) {
    if (this.path.e())
      return (
        (a = this.children.subtree(new M(a))),
        a.e()
          ? null
          : a.value
          ? new ac(this.source, C, a.value)
          : new md(this.source, C, a)
      );
    E(
      J(this.path) === a,
  ...
  g.F = function(a, b, c, d, e, f) {
    E(a.zc(this.g), "A node must be indexed if only a child is updated");
    e = a.R(b);
    if (e.Q(d).$(c.Q(d)) && e.e() == c.e()) return a;
    null != f &&
      (c.e()
        ? a.Fa(b)
          ? pd(f, new H("child_removed", e, b))
          : E(
              a.J(),
              "A child remove without an old child only makes sense on a leaf node"
            )
        : e.e()
        ? pd(f, new H("child_added", c, b))
        : pd(f, new H("child_changed", c, b, e)));
  ...
  function pd(a, b) {
    var c = b.type,
      d = b.Za;
    E(
      "child_added" == c || "child_changed" == c || "child_removed" == c,
    ...
    if (e) {
      ...
      if ("child_added" == c && "child_removed" == f)
        ...
        a.hb[d] = new H("child_removed", e.qe, d);
        ...
        throw Pc(
          "Illegal combination of changes: " + b + " occurred after " + e
        );
    } else a.hb[d] = b;
  }
  function wd(a, b) {
  ...
  xd.prototype.gb = function(a, b, c, d) {
    ...
    if (b.type === bc)
      b.source.ee
        ? (c = yd(this, a, b.path, b.Ja, c, d, e))
        : (E(b.source.We, "Unknown source."),
          (f = b.source.Ee || (yc(a.w()) && !b.path.e())),
          (c = zd(this, a, b.path, b.Ja, c, d, f, e)));
    else if (b.type === nd)
      b.source.ee
        ? (c = Ad(this, a, b.path, b.children, c, d, e))
        : (E(b.source.We, "Unknown source."),
          (f = b.source.Ee || yc(a.w())),
          (c = Bd(this, a, b.path, b.children, c, d, f, e)));
    else if (b.type === Dd)
      if (b.Id)
        if (((b = b.path), null != c.mc(b))) c = a;
          ...
          if (b.e() || ".priority" === J(b))
            ...
            b =
              null != k
                ? this.V.F(d, h, k, D(b), f, e)
                : a.O.j().Fa(h)
                ? this.V.F(d, h, F, D(b), f, e)
                : d;
            b.e() &&
              xc(a.w()) &&
              ((d = c.Ba(pc(a))), d.J() && (b = this.V.za(b, d, e)));
          }
      ...
      (d = b.path),
        ...
        (f = b.j()),
        (h = b.ea || d.e()),
        (c = Gd(this, new Hd(a.O, new oc(f, h, b.Tb)), d, c, lc, e));
  ...
  function Gd(a, b, c, d, e, f) {
    ...
    if (c.e())
      E(
        ...
        yc(b.w())
          ? ((e = pc(b)), (d = d.sc(e instanceof P ? e : F)))
          : (d = d.Ba(pc(b))),
        (f = a.V.za(b.O.j(), d, f));
    else {
      var m = J(c);
      if (".priority" == m)
        E(1 == Jd(c), "Can't have a priority with additional path components"),
          (f = h.j()),
          (k = b.w().j()),
          (d = d.$c(c, f, k)),
          (f = null != d ? a.V.ga(f, d) : h.j());
      else {
        var l = D(c);
        nc(h, m)
          ? ((k = b.w().j()),
  ...
  function yd(a, b, c, d, e, f, h) {
    ...
    if (c.e()) (h = a.V.za(b.O.j(), d, h)), (a = Ed(b, h, !0, a.V.Qa()));
    else if (((f = J(c)), ".priority" === f))
      (h = a.V.ga(b.O.j(), d)), (a = Ed(b, h, k.ea, k.Tb));
    else {
      c = D(c);
      var m = k.j().R(f);
      if (!c.e()) {
      ...
      m.$(d)
        ? (a = b)
        : ((h = a.V.F(k.j(), f, d, c, e, h)), (a = Ed(b, h, k.ea, a.V.Qa())));
    }
    return a;
  }
  ...
  function Fd(a, b, c, d, e, f, h) {
    ...
    if (null != d.value) {
      if ((c.e() && m.ea) || zc(m, c))
        return zd(a, b, c, m.j().Q(c), e, f, k, h);
      if (c.e()) {
        var l = Q;
  ...
  g.m = function(a) {
    ...
    if (a instanceof M) for (c = a.Z; c < a.o.length; c++) b.push(a.o[c]);
    else
  ...
  function Sd(a) {
    if (768 < a.Ka)
      throw Error(
        a.Te + "has a key path longer than 768 bytes (" + a.Ka + ")."
      );
    if (32 < a.Ta.length)
      throw Error(
        a.Te +
  ...
  function Zd(a, b, c) {
    ...
    if (ga(b))
      throw Error(
        a + "contains a function " + Td(c) + " with contents: " + b.toString()
      );
    if (Zc(b)) throw Error(a + "contains " + b.toString() + " " + Td(c));
    if (q(b) && b.length > 10485760 / 3 && 10485760 < Ob(b))
      throw Error(
        a +
    ...
    if (ha(b)) {
      ...
      Ib(b, function(b, h) {
        if (".value" === b) d = !0;
        else if (".priority" !== b && ".sv" !== b && ((e = !0), !Wd(b)))
          throw Error(
            a +
  ...
  function $d(a, b) {
    ...
    for (c = 0; c < b.length; c++) {
      ...
      for (var e = d.slice(), f = 0; f < e.length; f++)
        if ((".priority" !== e[f] || f !== e.length - 1) && !Wd(e[f]))
          throw Error(
            a +
              "contains an invalid key (" +
              e[f] +
  ...
  function ge(a, b) {
    var c = b.path.toString(),
      d;
    !(d = !q(b.kc.host) || 0 === b.kc.host.length || !Wd(b.kc.pe)) &&
      (d = 0 !== c.length) &&
      (c && (c = c.replace(/^\/*\.info(\/|$)/, "/")),
      (d = !(q(c) && 0 !== c.length && !Vd.test(c))));
    if (d)
      throw Error(
        Bb(a, 1, !1) +
  ...
  function je(a, b) {
    for (var c = b instanceof M ? b : new M(b), d = a, e; null !== (e = J(c)); )
      (d = new ie(e, d, A(d.A.children, e) || new he())), (c = D(c));
    return d;
  }
  g = ie.prototype;
  g.Ea = function() {
  ...
  function ke(a, b) {
    E("undefined" !== typeof b, "Cannot set value to undefined");
    a.A.value = b;
    le(a);
  }
  g.clear = function() {
  ...
  function le(a) {
    if (null !== a.Ha) {
      var b = a.Ha,
        ...
        e = Hb(b.A.children, c);
      d && e
        ? (delete b.A.children[c], b.A.ad--, le(b))
        : d || e || ((b.A.children[c] = a.A), b.A.ad++, le(b));
    }
  }
  function oe(a) {
    E(da(a) && 0 < a.length, "Requires a non-empty array");
    this.Kf = a;
    this.Ec = {};
  }
  ...
  function te(a, b, c) {
    ...
    return null !== a
      ? ((b = te(a, D(b), c)),
        null != b ? { path: new M(d).m(b.path), value: b.value } : null)
      : null;
  }
  function ue(a, b) {
  ...
  g.remove = function(a) {
    ...
    return c
      ? ((a = c.remove(D(a))),
        (b = a.e() ? this.children.remove(b) : this.children.Ra(b, a)),
        null === this.value && b.e() ? Q : new qe(this.value, b))
      : this;
  };
  g.get = function(a) {
    ...
    "undefined" !== typeof document &&
      ...
      ("undefined" !== typeof document.hidden
        ...
        : "undefined" !== typeof document.webkitHidden &&
          ((b = "webkitvisibilitychange"), (a = "webkitHidden")));
    this.Nb = !0;
    if (b) {
      var c = this;
      document.addEventListener(
  ...
  ka(He, oe);
  He.prototype.Ye = function(a) {
    E("visible" === a, "Unknown event type: " + a);
    return [this.Nb];
  };
  ba(He);
  function Ie() {
  ...
  function Ke(a, b) {
    return a && "object" === typeof a
      ? (E(".sv" in a, "Unexpected leaf node or priority contents"),
        b[a[".sv"]])
      : a;
  }
  function Le(a, b) {
    var c = new Me();
    Ne(a, new M(""), function(a, e) {
      Oe(c, a, Pe(e, b));
    });
    return c;
  }
  ...
  Re.prototype.Ye = function(a) {
    E("online" === a, "Unknown event type: " + a);
    return [this.ic];
  };
  ba(Re);
  function Se() {}
  ...
  g.Fc = function(a) {
    E(q(a), "KeyIndex indexValue must always be a string.");
    return new O(a, F);
  };
  g.toString = function() {
    return ".key";
  ...
  g = lf.prototype;
  g.F = function(a, b, c, d, e, f) {
    this.ta.matches(new O(b, c)) || (c = F);
    return a.R(b).$(c)
      ? a
      : a.Fb() < this.pa
      ? this.ta.Vb().F(a, b, c, d, e, f)
      : nf(this, a, b, c, e, f);
  };
  g.za = function(a, b, c) {
    var d;
    if (b.J() || b.e()) d = F.ob(this.g);
    else if (2 * this.pa < b.Fb() && b.zc(this.g)) {
      d = F.ob(this.g);
      ...
      for (var e = 0; 0 < b.Sa.length && e < this.pa; ) {
        ...
        if (
          (h = this.Jb
            ? 0 >= this.g.compare(this.ta.Uc, f)
            : 0 >= this.g.compare(f, this.ta.wc))
        )
          (d = d.U(f.name, f.S)), e++;
        else break;
      }
      ...
      if (this.Jb) {
        ...
        (b = d.Xb(this.g)),
          ...
          (m = this.ta.wc),
          (l = Ue(this.g));
      for (var e = 0, z = !1; 0 < b.Sa.length; )
        (f = K(b)),
          !z && 0 >= l(k, f) && (z = !0),
          (h = z && e < this.pa && 0 >= l(f, m)) ? e++ : (d = d.U(f.name, F));
    }
  ...
  function nf(a, b, c, d, e, f) {
    ...
    if (b.Fa(c)) {
      ...
      e = null == l ? 1 : h(l, m);
      if (u && !d.e() && 0 <= e)
        return null != f && pd(f, new H("child_changed", d, c, z)), b.U(c, d);
      null != f && pd(f, new H("child_removed", z, c));
      b = b.U(c, F);
      return null != l && a.ta.matches(l)
        ? (null != f && pd(f, new H("child_added", l.S, l.name)),
          b.U(l.name, l.S))
        : b;
    }
    return d.e()
      ...
      : u && 0 <= h(l, m)
      ? (null != f &&
          (pd(f, new H("child_removed", l.S, l.name)),
          pd(f, new H("child_added", d, c))),
        b.U(c, d).U(l.name, F))
      : b;
  }
  function qf(a) {
  ...
  function rf(a, b, c, d) {
    ...
    Ga(b, function(b) {
      "child_changed" === b.type &&
        a.g.nd(b.qe, b.Ma) &&
        f.push(new H("child_moved", b.Ma, b.Za));
    });
  ...
  function tf(a, b, c) {
    "value" !== b.type &&
      ...
      (b.Dd = c.Ze(b.Za, b.Ma, a.g));
    return b;
  }
  qf.prototype.Of = function(a, b) {
    if (null == a.Za || null == b.Za)
      throw Pc("Should only compare child_ events.");
  ...
  function sd(a) {
    E(a.la, "Only valid if start has been set");
    return a.ec;
  }
  function rd(a) {
    E(a.la, "Only valid if start has been set");
  ...
  function ud(a) {
    E(a.oa, "Only valid if end has been set");
    return a.bc;
  }
  function td(a) {
    E(a.oa, "Only valid if end has been set");
  ...
  function Af(a) {
    ...
    a.g === N
      ...
      : a.g === Od
      ? (c = "$key")
      : (E(a.g instanceof We, "Unrecognized index type!"),
        (c = a.g.toString()));
    b.orderBy = B(c);
  ...
  g.H = function(a) {
    return a && !this.C().e()
      ? { ".value": this.Ea(), ".priority": this.C().H() }
      : this.Ea();
  };
  g.hash = function() {
    if (null === this.Eb) {
  ...
  g.U = function(a, b) {
    E(b, "We should always be passing snapshot nodes");
    if (".priority" === a) return this.ga(b);
    var c = new O(a, b),
      d,
      e;
    b.e()
      ? ((d = this.k.remove(a)), (c = jf(this.zb, c, this.k)))
      : ((d = this.k.Ra(a, b)), (c = ff(this.zb, c, this.k)));
    e = d.e() ? F : this.ba;
    return new P(d, e, c);
  };
  g.F = function(a, b) {
  ...
  g.Yb = function(a, b) {
    ...
    for (
      var c = this.k.Yb(a.name, gf), d = Ec(c);
  ...
  g.$b = function(a, b) {
    ...
    for (
      var c = this.k.$b(a.name, gf), d = Ec(c);
      null != d && 0 < b.compare(d, a);
  ...
  g.ob = function(a) {
    ...
    for (var d = [], e = !1, c = c.Xb(gf), f = K(c); f; )
  ...
  var Gf = Math.log(2);
  function Hf(a) {
    this.count = parseInt(Math.log(a + 1) / Gf, 10);
  ...
  function Qf(a, b, c, d) {
    ...
    a.Vd.getToken(!1).then(function(e) {
      ...
      h.onreadystatechange = function() {
        if (d && 4 === h.readyState) {
          a.f(
            "REST Response for " + f + " received. status:",
            h.status,
            "response:",
            h.responseText
          );
          ...
          if (200 <= h.status && 300 > h.status) {
            try {
              ...
              L(
                "Failed to parse JSON response for " + f + ": " + h.responseText
              );
            }
            d(null, b);
          } else
  ...
  Rf.prototype.getToken = function(a) {
    return this.He.INTERNAL.getToken(a).then(null, function(a) {
      return a && "auth/token-not-initialized" === a.code
        ? (I("Got auth/token-not-initialized error.  Treating as null token."),
          null)
        : Promise.reject(a);
    });
  };
  ...
  "undefined" !== typeof MozWebSocket
    ? (ag = MozWebSocket)
    : "undefined" !== typeof WebSocket && (ag = WebSocket);
  function bg(a, b, c, d) {
    this.Zd = a;
    this.f = Vc(this.Zd);
    ...
    this.La.onmessage = function(a) {
      if (null !== e.La)
        if (
          ((a = a.data),
          (e.qb += a.length),
          Vf(e.Xa, "bytes_received", a.length),
          dg(e),
          null !== e.frames)
        )
          eg(e, a);
          ...
          a: {
            E(null === e.frames, "We already have a frame buffer");
            if (6 >= a.length) {
              var b = Number(a);
              if (!isNaN(b)) {
                e.Fe = b;
  ...
  g.fb = function() {
    this.Bb ||
      ...
      this.Tc(),
      this.kb && (this.kb(this.xc), (this.kb = null)));
  };
  g.close = function() {
      ...
      if (!c.Bb) {
        c.Wa = new jg(
          function(a, b, d, k, m) {
            ...
            if (c.Wa)
              if (
                (c.tb && (clearTimeout(c.tb), (c.tb = null)),
                (c.xc = !0),
                "start" == a)
              )
                (c.id = b), (c.mf = d);
  ...
  gg.isAvailable = function() {
    return (
      ...
      (!ig &&
        ...
        !("object" === typeof Windows && "object" === typeof Windows.Dg) &&
        !0)
    );
  };
  g = gg.prototype;
  ...
  g.fb = function() {
    this.Bb ||
      ...
      this.Tc(),
      this.ja && (this.ja(this.xc), (this.ja = null)));
  };
  g.close = function() {
  ...
  function jg(a, b, c, d) {
    ...
    a.contentDocument
      ? (a.ib = a.contentDocument)
      : a.contentWindow
      ? (a.ib = a.contentWindow.document)
      : a.document && (a.ib = a.document);
    this.Ga = a;
    a = "";
    this.Ga.src &&
      "javascript:" === this.Ga.src.substr(0, 11) &&
      (a = '<script>document.domain="' + document.domain + '";\x3c/script>');
      ...
      (a.md = setTimeout(function() {
        ...
        a.Cb ||
          (a.I && 102400 < a.I.qb
            ...
            : (a.f("Closing unhealthy connection after timeout."), a.close()));
      }, Math.floor(b)));
  }
  function vg(a, b) {
    return function(c) {
      b === a.I
        ? ((a.I = null),
          c || 0 !== a.L
            ? 1 === a.L && a.f("Realtime connection lost.")
            : (a.f("Realtime connection failed."),
              "s-" === a.M.bb.substr(0, 2) &&
                (Xb.remove("host:" + a.M.host), (a.M.bb = a.M.host))),
          a.close())
        : b === a.D
        ? (a.f("Secondary connection lost."),
          (c = a.D),
          (a.D = null),
          (a.Xc !== c && a.Rc !== c) || a.close())
            ...
            if (((d = cd("t", c)), "d" in c))
              if (((c = c.d), "h" === d)) {
                ...
                0 == a.L &&
                  (a.I.start(),
                  wg(a, a.I, d),
                  "5" !== e && L("Protocol version mismatch detected"),
                  (c = a.Af),
                  (c = 1 < c.Wc.length ? c.Wc[1] : null) && xg(a, c));
              } else if ("n" === d) {
                ...
                "s" === d
                  ? (a.f(
                    ...
                    a.se && (a.se(c), (a.se = null)),
                    (a.ja = null),
                    a.close())
                  : "r" === d
                  ? (a.f("Reset packet received.  New host: " + c),
                    dc(a.M, c),
                    1 === a.L ? a.close() : (zg(a), tg(a)))
                  : "e" === d
                  ? Wc("Server Error: " + c)
                  : "o" === d
                  ? (a.f("got pong on primary."), Ag(a), Bg(a))
                  : Wc("Unknown control packet command: " + d);
          } else "d" == d && a.wd(c);
        } else if (b === a.D)
          if (((d = cd("t", c)), (c = cd("d", c)), "c" == d))
            "t" in c &&
              ((c = c.t),
              "a" === c
                ? Cg(a)
                : "r" === c
                ? (a.f("Got a reset on secondary, closing it"),
                  a.D.close(),
                  (a.Xc !== a.D && a.Rc !== a.D) || a.close())
                : "o" === c && (a.f("got pong on secondary."), a.xf--, Cg(a)));
  ...
  function yg(a) {
    a.Xc === a.D &&
      a.Rc === a.D &&
      (a.f("cleaning up and promoting a connection: " + a.D.Zd),
      (a.I = a.D),
      (a.D = null));
  }
  function Cg(a) {
  ...
  function Ag(a) {
    a.Cb ||
      (a.xe--,
      0 >= a.xe &&
        (a.f("Primary connection is healthy."), (a.Cb = !0), a.I.sd()));
  }
  function xg(a, b) {
  ...
  function wg(a, b, c) {
    ...
    0 === a.xe
      ? (a.f("Primary connection is healthy."), (a.Cb = !0))
      : setTimeout(function() {
          Bg(a);
        }, Math.floor(5e3));
  }
  ...
  function Eg(a, b, c, d, e, f) {
    ...
    Gg(this, 0);
    He.Wb().hc("visible", this.jg, this);
    -1 === a.host.indexOf("fblocal") && Re.Wb().hc("online", this.ig, this);
  }
  var Fg = 0,
    Hg = 0;
  g = Eg.prototype;
  ...
  g.re = function(a, b, c) {
    this.na
      ? Mg(this, "o", a, b, c)
      : this.Lc.push({ we: a, action: "o", data: b, G: c });
  };
  g.gf = function(a, b, c) {
    this.na
      ? Mg(this, "om", a, b, c)
      : this.Lc.push({ we: a, action: "om", data: b, G: c });
  };
  g.xd = function(a, b) {
    this.na
      ? Mg(this, "oc", a, null, b)
      : this.Lc.push({ we: a, action: "oc", data: null, G: b });
  };
  ...
  g.wd = function(a) {
    if ("r" in a) {
      ...
      "a" in a &&
        ((b = a.a),
        (a = a.b),
        this.f("handleServerMessage", b, a),
        "d" === b
          ? this.Hb(a.p, a.d, !1, a.t)
          : "m" === b
          ? this.Hb(a.p, a.d, !0, a.t)
          : "c" === b
          ? Pg(this, a.p, a.q)
          : "ac" === b
          ? Lg(this, a.s, a.d)
  ...
  function Gg(a, b) {
    E(!a.Ia, "Scheduling a connect when we're already connected/ing?");
  ...
  g.jf = function() {
    ...
    for (var a = 0; a < this.qa.length; a++) {
      ...
      b &&
        "h" in b.sf &&
        b.qg &&
        (b.G && b.G("disconnect"), delete this.qa[a], this.Pc--);
    }
    0 === this.Pc && (this.qa = []);
    this.Gd = {};
    Sg(this) &&
      (this.Nb
        ? this.Bc &&
          (3e4 < new Date().getTime() - this.Bc && (this.Va = 1e3),
          (this.Bc = null))
        : (this.f("Window isn't visible.  Delaying reconnect."),
          (this.Va = this.td),
          (this.me = new Date().getTime())),
      (a = Math.max(0, this.Va - (new Date().getTime() - this.me))),
      (a *= Math.random()),
      this.f("Trying to reconnect in " + a + "ms"),
      Gg(this, a),
      (this.Va = Math.min(this.td, 1.3 * this.Va)));
    this.Kc(!1);
  };
  function Rg(a) {
    if (Sg(a)) {
      ...
      a.Ia = {
        close: m,
        va: function(a) {
          E(k, "sendRequest call when we're not connected not allowed.");
          k.va(a);
        }
      };
      var l = a.de;
  ...
  g.eb = function(a) {
    ...
    this.Ia
      ? this.Ia.close()
      : (this.vb && (clearTimeout(this.vb), (this.vb = null)),
        this.na && this.jf());
  };
  g.lc = function(a) {
  ...
  function Qg(a) {
    ...
    for (; a.Lc.length; )
      (b = a.Lc.shift()), Mg(a, b.action, b.we, b.data, b.G);
  }
  function Sg(a) {
    var b;
    b = Re.Wb().ic;
  ...
  function $g(a, b, c) {
    ...
    b.children.ia(function(b, f) {
      ".priority" === b
        ? (E(null !== f.value, "Priority writes must always be leaf nodes"),
          (d = f.value))
        : (c = $g(a.m(b), f, c));
    });
  ...
  g.Ed = function(a) {
    ...
    for (var d = c.visible, e = !1, f = this.ma.length - 1; d && 0 <= f; ) {
      ...
      h.visible &&
        (f >= b && ch(h, c.path)
          ? (d = !1)
          : c.path.contains(h.path) && (e = !0));
      f--;
    }
    if (d) {
      if (e)
        (this.T = dh(this.ma, eh, C)),
          (this.Cc = 0 < this.ma.length ? this.ma[this.ma.length - 1].Zc : -1);
        ...
        ? ((e = dh(
            ...
            function(b) {
              return (
                (b.visible || d) &&
                (!c || !(0 <= Fa(c, b.Zc))) &&
                (b.path.contains(a) || a.contains(b.path))
              );
            },
            a
          )),
  ...
  g.$c = function(a, b, c, d) {
    E(c || d, "Either existingEventSnap or existingServerSnap must exist");
    a = a.m(b);
  ...
  function dh(a, b, c) {
    for (var d = Ug, e = 0; e < a.length; ++e) {
      ...
      if (b(f)) {
        ...
        if (f.Ja)
          c.contains(h)
            ? ((h = R(c, h)), (d = Vg(d, h, f.Ja)))
            : h.contains(c) && ((h = R(h, c)), (d = Vg(d, C, f.Ja.Q(h))));
        else if (f.children)
          if (c.contains(h)) (h = R(c, h)), (d = Wg(d, h, f.children));
          else {
            if (h.contains(c))
              if (((h = R(h, c)), h.e())) d = Wg(d, C, f.children);
              else if ((f = A(f.children, J(h))))
                (f = f.Q(D(h))), (d = Vg(d, C, f));
          }
  ...
  function gh(a, b) {
    ...
    return null !== a.k
      ? ((c = J(b)),
        (b = D(b)),
        a.k.contains(c) && gh(a.k.get(c), b) && a.k.remove(c),
        a.k.e() ? ((a.k = null), !0) : !1)
      : !0;
  }
  function Ne(a, b, c) {
        ...
        if (b === na(this.ha)) {
          if (1 === b) {
            var b = oa(a.ha),
              c = oa(this.ha);
            return (
              c === b && (!a.ha[b] || !this.ha[c] || a.ha[b] === this.ha[c])
            );
          }
  ...
  g.gb = function(a, b, c) {
    ...
    if (null !== d)
      return (
        (d = A(this.Aa, d)),
        E(null != d, "SyncTree gave us an op for an invalid query."),
        d.gb(a, b, c)
      );
    var e = [];
  ...
  g.mb = function(a, b, c) {
    ...
    if ("default" === d) {
      ...
      t(this.Aa, function(a, d) {
        f = f.concat(a.mb(b, c));
        a.e() && (delete k.Aa[d], T(a.W.n) || e.push(a.W));
      });
    } else {
      var m = A(this.Aa, d);
      m &&
        ((f = f.concat(m.mb(b, c))),
        m.e() && (delete this.Aa[d], T(m.W.n) || e.push(m.W)));
    }
  ...
  qh.prototype.Ob = function(a, b) {
    ...
    var f = this.xa.get(c);
    f
      ? ((e = e || null != nh(f)), (d = d || f.jb(C)))
      : ((f = new mh()), (this.xa = this.xa.set(c, f)));
    var h;
    null != d
      ? (h = !0)
      : ((h = !1),
        (d = F),
        Ce(this.xa.subtree(c), function(a, b) {
          var c = b.jb(C);
          c && (d = d.U(a, c));
        }));
    var k = null != ph(f, a);
    ...
    k || e || ((f = ph(f, a)), (h = h.concat(Dh(this, a, f))));
    return h;
  };
    ...
    return {
      ...
      G: function(b) {
        ...
        "too_big" === b
          ...
          : "permission_denied" == b
          ? (f = "Client doesn't have permission to access the desired data.")
          : "unavailable" == b && (f = "The service is unavailable");
  ...
  function Lh(a) {
    ...
    if (a.g === Od) {
      ...
      (E(a.g instanceof We || a.g === bf, "unknown index type."),
  ...
  g.hc = function(a, b, c, d) {
    ...
    if ("value" === a)
      Ph(this.u, this, new kh(b, e.cancel || null, e.Pa || null));
    else {
      var f = {};
      f[a] = b;
  ...
  g.Jc = function(a, b, c) {
    ...
    var d = null,
      e = null;
    "value" === a
      ? (d = new kh(b || null, null, c || null))
      : a && (b && ((e = {}), (e[a] = b)), (d = new lh(e, null, c || null)));
    e = this.u;
  ...
  function Oh(a, b, c) {
    ...
    if (b && c)
      (d.cancel = b), y(a, 3, d.cancel, !0), (d.Pa = c), Cb(a, 4, d.Pa);
    else if (b)
  ...
  Sh.prototype.delete = function() {
    ...
    var a = Vh.Wb(),
      b = this.$a.ua;
    A(a.nb, b.app.name) !== b &&
      Xc("Database " + b.app.name + " has already been deleted.");
    b.eb();
  ...
  function Rh(a, b, c) {
    ...
    if (
      ...
      (this.wa = new Of(this.M, r(this.Hb, this), d)),
        setTimeout(r(this.Kc, this, !0), 0);
    else {
  ...
  function Xh(a) {
    a = a.ie.j(new M(".info/serverTimeOffset")).H() || 0;
    ...
    d
      ? c
        ? ((b = la(b, function(a) {
          ...
          (a = Ah(this.K, e, b, d)))
        : ((b = S(b)), (a = wh(this.K, e, b, d)))
      : c
      ? ((d = la(b, function(a) {
          return S(a);
        })),
        (a = vh(this.K, e, d)))
      : ((d = S(b)), (a = sh(this.K, new ac(Ge, e, d))));
    d = e;
  ...
  g.update = function(a, b, c) {
    ...
    if (d)
      I("update() called with empty data.  Don't do anything."), ai(c, "ok");
    else {
      var h = this.vd++,
        k = th(this.K, a, f, h);
      rc(this.da, k);
  ...
  function jh(a, b, c, d) {
    ...
    e
      ? (I(
        ...
        ai(d, "ok"))
      : a.wa.gf(b.toString(), c, function(e, f) {
          if ("ok" === e)
            for (var m in c) {
              var l = S(c[m]);
              Oe(a.ja, b.m(m), l);
  ...
  g.Be = function(a) {
    if ("undefined" !== typeof console) {
      a
        ? (this.Vc || (this.Vc = new Tf(this.Xa)), (a = this.Vc.get()))
        : (a = this.Xa.get());
      var b = Ja(
          qa(a),
          function(a, b) {
  ...
  function ci(a, b, c, d, e) {
    ...
    if (p(d)) {
      ...
      k.push(c);
      ke(e, k);
      "object" === typeof d && null !== d && Hb(d, ".priority")
        ? ((k = A(d, ".priority")),
          E(
            Xd(k),
      ...
      c.Rd(),
        (c.cd = null),
        (c.dd = null),
        c.G && ((a = new V(c.bd, new W(a, c.path), N)), c.G(null, !1, a));
  }
  function di(a, b) {
    var c = b || a.nc;
    b || ei(a, c);
      ...
      function(d) {
        ...
        if ("ok" === d) {
          ...
          if ("datastale" === d)
            ...
            for (
              L("transaction at " + b.toString() + " failed: " + d), f = 0;
              f < c.length;
              f++
            )
  ...
  function ii(a, b, c) {
    if (0 !== b.length) {
      for (
        ...
        if (5 === k.status)
          (l = !0), (u = k.Td), (e = e.concat(uh(a.K, k.Da, !0)));
        else if (1 === k.status)
          if (25 <= k.wf)
            (l = !0), (u = "maxretry"), (e = e.concat(uh(a.K, k.Da, !0)));
          else {
            var z = a.K.Ba(k.path, f) || F;
            k.bd = z;
            var G = b[h].update(z.H());
            p(G)
              ? (Zd("transaction failed: Data returned ", G, k.path),
                (m = S(G)),
                ("object" === typeof G && null != G && Hb(G, ".priority")) ||
                  (m = m.ga(z.C())),
                (z = k.Da),
                (G = Yh(a)),
                (G = Pe(m, G)),
                ...
                (k.Da = a.vd++),
                Na(f, z),
                (e = e.concat(rh(a.K, k.path, G, k.Da, k.Ie))),
                (e = e.concat(uh(a.K, z, !0))))
              : ((l = !0), (u = "nodata"), (e = e.concat(uh(a.K, k.Da, !0))));
          }
        vc(a.da, c, e);
        e = [];
        l &&
          ((b[h].status = 3),
          setTimeout(b[h].Rd, Math.floor(0)),
          b[h].G &&
            ("nodata" === u
              ? ((k = new W(a, b[h].path)),
                d.push(r(b[h].G, null, null, !1, new V(b[h].bd, k, N))))
              : d.push(r(b[h].G, null, Error(u), !1, null))));
      }
      ei(a, a.nc);
        ...
        4 !== c[h].status &&
          (2 === c[h].status
            ? (E(
              ...
              (c[h].status = 4),
              (c[h].Td = "set"))
            : (E(1 === c[h].status, "Unexpected transaction status in abort"),
              c[h].Rd(),
              (e = e.concat(uh(a.K, c[h].Da, !0))),
              c[h].G && d.push(r(c[h].G, null, Error("set"), !1, null))));
      -1 === f ? ke(b, null) : (c.length = f + 1);
      vc(a.da, b.path(), e);
      for (h = 0; h < d.length; h++) Tb(d[h]);
    }
  }
  ...
  Y.bg = function(a) {
    ...
    Eg.prototype.put = function(c, d, e, f) {
      p(f) && (f = a());
      b.call(this, c, d, e, f);
    };
    return function() {
  ...
  function W(a, b) {
    if (!(a instanceof Rh))
      throw Error("new Firebase() no longer supported - use app.database().");
  ...
  g.Kb = function(a, b, c) {
    ...
    if (".length" === this.getKey() || ".keys" === this.getKey())
      throw "Firebase.setWithPriority failed: " +
        this.getKey() +
  ...
  g.transaction = function(a, b, c) {
    ...
    if (p(c) && "boolean" != typeof c)
      throw Error(Bb("Firebase.transaction", 3, !0) + "must be a boolean.");
    if (".length" === this.getKey() || ".keys" === this.getKey())
      throw "Firebase.transaction failed: " +
        this.getKey() +
        " is a read-only object.";
    ...
    ci(
      ...
      a,
      function(a, c, h) {
        a ? d.reject(a) : d.resolve(new li(c, h));
        ga(b) && b(a, c, h);
      },
      c
    );
  ...
  g.kb = function() {
    fe("Firebase.onDisconnect", this.path);
  ...
  try {
    firebase.INTERNAL.registerService(
      ...
      function(a) {
        ...
        (d = A(b.nb, a.name)) &&
          Xc("FIREBASE INTERNAL ERROR: Database initialized multiple times.");
        d = new Rh(c, b.Ff, a);
        b.nb[a.name] = d;
        return d.$a;
      },
...
(function() {
  ...
  var ka = function(a, b, c) {
    ...
    function g(a) {
      ec ||
        ((ec = !0),
        N ||
          (null !== m ? (a || (O = 2), clearTimeout(m), e(0)) : a || (O = 1)));
    }
    var h = 1,
      m = null,
      x = !1,
  ...
  za.prototype.get = function() {
    var a;
    0 < this.b
      ? (this.b--, (a = this.a), (this.a = a.next), (a.next = null))
      : (a = this.c());
    return a;
  };
  var Aa = function(a, b) {
  ...
  var Ta = function(a, b, c) {
    r(a) || y(b) || y(c)
      ? ((this.next = a), (this.a = b || null), (this.b = c || null))
  ...
  var Ua = {
    ...
    Za = function(a) {
      ...
      if (null != b) {
        var c = b.length - 7;
        this.b = (this.a = 0 <= c && b.indexOf(";base64", c) == c)
          ? b.substring(0, b.length - 7)
          : b;
      }
  ...
  var nb = Array.prototype.indexOf
    ...
    pb = Array.prototype.filter
      ...
      : function(a, b, c) {
          for (
            var d = a.length, e = [], f = 0, g = q(a) ? a.split("") : a, h = 0;
            h < d;
            h++
          )
            if (h in g) {
    ...
    qb = Array.prototype.map
      ...
      : function(a, b, c) {
          for (
            var d = a.length, e = Array(d), f = q(a) ? a.split("") : a, g = 0;
            g < d;
            g++
          )
            g in f && (e[g] = b.call(c, f[g], g, a));
    ...
    wb = function(a, b) {
      ...
      var c;
      if ((c = 0 <= b))
        B(null != a.length), Array.prototype.splice.call(a, b, 1);
      return c;
    },
    xb = function(a) {
      var b = a.length;
  ...
  var Ib = function(a) {
    ...
    Kb = function(a, b, c, d, e, f) {
      ...
      -1 < h
        ? ((a = b[h]), d || (a.T = !1))
        : ((a = new Db(c, a.src, g, !!e, f)), (a.T = d), b.push(a));
      return a;
    },
    Lb = function(a, b) {
      var c = b.type;
      c in a.a &&
        wb(a.a[c], b) &&
        (Eb(b), 0 == a.a[c].length && (delete a.a[c], a.b--));
    },
    Jb = function(a, b, c, d) {
      for (var e = 0; e < a.length; ++e) {
        var f = a[e];
  ...
  var Tb = function(a) {
    ...
    Ub = function(a, b) {
      if (a.forEach && "function" == typeof a.forEach) a.forEach(b, void 0);
        ...
        for (var d = Tb(a), e = d.length, f = 0; f < e; f++)
          b.call(void 0, d[f], c && c[f], a);
      }
    };
  var Vb = function(a) {
  ...
  var ac = C("Opera"),
    ...
    cc =
      C("Gecko") &&
      !(-1 != ib.toLowerCase().indexOf("webkit") && !C("Edge")) &&
      !(C("Trident") || C("MSIE")) &&
      !C("Edge"),
  ...
  var kc = gc,
    ...
    mc =
      lc && D
        ? fc() || ("CSS1Compat" == lc.compatMode ? parseInt(kc, 10) : 5)
        : void 0;
  var qc = function(a, b) {
      nc || oc();
      pc || (nc(), (pc = !0));
  ...
  var wc = function(a, b) {
      return Object.prototype.hasOwnProperty.call(a.c, b)
        ? (delete a.c[b], a.f--, a.g++, a.a.length > 2 * a.f && vc(a), !0)
        : !1;
    },
    vc = function(a) {
      if (a.f != a.a.length) {
  ...
  F.prototype.set = function(a, b) {
    Object.prototype.hasOwnProperty.call(this.c, a) ||
      (this.f++, this.a.push(a), this.g++);
    this.c[a] = b;
  };
      ...
      if (0 == a.a) {
        ...
        a: {
          var e = c,
            ...
            g = a.m;
          if (e instanceof G)
            null != f && eb(f, "opt_onFulfilled should be a function."),
              null != g &&
                eb(
                  g,
                  "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"
                ),
              Gc(e, Bc(f || ba, g || null, a)),
              (d = !0);
  ...
  var Pc = "closure_lm_" + ((1e6 * Math.random()) | 0),
    ...
    Sc = function(a, b, c, d, e) {
      ...
      c = Tc(c);
      a && a[gb]
        ? (Uc(a), (a = Kb(a.b, String(b), c, !1, d, e)))
        : (a = Vc(a, b, c, !1, d, e));
      return a;
    },
    ...
    bd = function(a) {
      ...
      var c = a.type,
        d = a.a;
      b.removeEventListener
        ? b.removeEventListener(c, d, a.U)
        : b.detachEvent && b.detachEvent(Yc(c), d);
      Rc--;
      (c = Wc(b))
        ? (Lb(c, a), 0 == c.b && ((c.src = null), (b[Pc] = null)))
        : Eb(a);
    },
    Yc = function(a) {
...
*/
  ...
  var kd = function(a, b, c) {
    B(!a.j, "Blocking Deferreds can not be re-used");
    a.c.push([b, c, void 0]);
    a.h && jd(a);
  };
  ...
  var ld = function(a) {
    ...
    jd = function(a) {
      ...
      for (var b = a.b, d = (c = !1); a.c.length && !a.g; ) {
        ...
        if ((f = a.a ? g : f))
          try {
            ...
            n(h) &&
              ((a.a = a.a && (h == b || h instanceof Error)), (a.b = b = h));
            if (
              Ja(b) ||
              ("function" === typeof l.Promise && b instanceof l.Promise)
            )
      ...
      d &&
        ((h = t(a.l, a, !0)),
        (d = t(a.l, a, !1)),
        b instanceof id ? (kd(b, h, d), (b.j = !0)) : b.then(h, d));
  ...
  nd.prototype.c = function() {
    B(md[this.a], "Cannot throw an error that is not scheduled.");
    delete md[this.a];
    throw this.b;
  };
  var md = {};
  ...
  var I = function(a, b) {
    ...
    q(b)
      ...
      : b instanceof Cb
      ? (b.target = b.target || a)
      : ((e = b), (b = new Cb(d, a)), Ha(b, e));
    var e = !0,
      f;
    if (c)
      for (var g = c.length - 1; 0 <= g; g--)
        (f = b.a = c[g]), (e = yd(f, d, !0, b) && e);
    f = b.a = a;
    e = yd(f, d, !0, b) && e;
    e = yd(f, d, !1, b) && e;
    if (c)
      for (g = 0; g < c.length; g++)
        (f = b.a = c[g]), (e = yd(f, d, !1, b) && e);
  };
  ...
  L.prototype.send = function(a, b, c, d) {
    ...
    this.ca &&
      ...
      this.a.upload && (this.a.upload.onprogress = t(this.M, this)));
    try {
      ...
      K(this.v, M(this, "Error opening Xhr: " + f.message));
      Ed(this, f);
      return;
    }
    a = c || "";
      ...
      Fd(this),
        0 < this.i &&
          ...
          K(
            ...
            M(
              this,
              "Will abort after " + this.i + "ms if incomplete, xhr2 " + this.u
            )
          ),
          this.u
            ? ((this.a.timeout = this.i), (this.a.ontimeout = t(this.K, this)))
            : (this.m = zd(this.K, this.i, this))),
        K(this.v, M(this, "Sending request")),
        (this.j = !0),
        this.a.send(a),
        (this.j = !1);
    } catch (f) {
  ...
  L.prototype.K = function() {
    "undefined" != typeof aa &&
      this.a &&
      ((this.h = "Timed out after " + this.i + "ms, aborting"),
      (this.J = 8),
      K(this.v, M(this, this.h)),
      I(this, "timeout"),
      Hd(this, 8));
  };
  var Ed = function(a, b) {
  ...
  L.prototype.C = function() {
    this.a &&
      (this.c && ((this.c = !1), (this.f = !0), this.a.abort(), (this.f = !1)),
      Jd(this, !0));
    L.I.C.call(this);
  };
  ...
  var Kd = function(a) {
    if (a.c && "undefined" != typeof aa)
      if (a.w[1] && 4 == Ld(a) && 2 == P(a))
        K(a.v, M(a, "Local request error detected and ignored"));
      else if (a.j && 4 == Ld(a)) zd(a.P, 0, a);
      else if ((I(a, "readystatechange"), 4 == Ld(a))) {
        K(a.v, M(a, "Request complete"));
        a.c = !1;
        try {
  ...
  var Nd = function(a, b) {
    ...
    Md = function(a) {
      ...
      if (!c) {
        if ((b = 0 === b))
          (a = String(a.l).match(Fb)[1] || null),
            !a &&
              l.self &&
              l.self.location &&
              ((a = l.self.location.protocol), (a = a.substr(0, a.length - 1))),
            (b = !Cd.test(a ? a.toLowerCase() : ""));
        c = b;
      }
      return c;
    },
  ...
  var fd = new Qd();
  var Sd = function(a, b, c, d, e, f, g, h, m, x, O) {
      this.L = a;
      this.G = b;
      this.B = c;
      this.u = d;
      ...
      function b(a, b) {
        b
          ...
          : fd.W(function(b) {
              ...
              null !== d.g &&
                ((b.ca = !0),
                (c = Sc(b, "uploadprogress", function(a) {
              ...
              $c(b, "complete", function(b) {
                ...
                if (!(f = !f))
                  var g = d,
                    ...
                    f = f || h || g;
                f
                  ? ((e = 7 === b.J), gd(b), a(!1, new Td(!1, null, e)))
                  : ((e = ub(d.K, e)), a(!0, new Td(e, b)));
              });
            });
      }
      function c(a, b) {
  ...
  var Ud = function(a, b, c) {
    ...
    e["X-Firebase-Storage-Version"] =
      "webjs/" +
      ("undefined" !== typeof firebase ? firebase.SDK_VERSION : "AppManager");
  ...
  var Vd = function(a) {
      ...
      if (n(c)) {
        ...
        b = c.getBlob(void 0);
      } else if (n(l.Blob)) b = new Blob(b, {});
      else throw Error("This browser doesn't seem to support creating Blobs");
      return b;
    },
    Wd = function(a, b, c) {
      n(c) || (c = a.size);
      return a.webkitSlice
        ? a.webkitSlice(b, c)
        : a.mozSlice
        ? a.mozSlice(b, c)
        : a.slice
        ? (cc && !E("13.0")) || (dc && !E("537.1"))
          ? (0 > b && (b += a.size),
            0 > b && (b = 0),
            0 > c && (c += a.size),
            c < b && (c = b),
  ...
  var Q = function(a, b) {
    ya() && a instanceof Blob
      ? ((this.s = a), (b = a.size), (a = a.type))
      : (a instanceof ArrayBuffer
          ? (b
              ? (this.s = new Uint8Array(a))
              : ((this.s = new Uint8Array(a.byteLength)),
                this.s.set(new Uint8Array(a))),
            (b = this.s.length))
          : (b
              ? (this.s = a)
              : ((this.s = new Uint8Array(a.length)), this.s.set(a)),
            (b = a.length)),
        (a = ""));
    this.a = b;
    this.b = a;
  ...
  Q.prototype.slice = function(a, b) {
    if (ya() && this.s instanceof Blob)
      return (a = Wd(this.s, a, b)), null === a ? null : new Q(a);
  ...
  var be = function(a, b, c, d) {
    ...
    ce = function(a) {
      return null !== a.a && y(a.a.INTERNAL) && y(a.a.INTERNAL.getToken)
        ? a.a.INTERNAL.getToken().then(
            function(a) {
  ...
  var de = function(a, b) {
    ...
    fe = function() {
      ...
      a.push(new S("cacheControl", null, !0));
      ...
      a.push(
        new S("downloadTokens", "downloadURLs", !1, function(a, b) {
    ...
    ie = function(a) {
      ...
      for (var b in a) {
        var c = a[b];
        if ("customMetadata" === b && "object" !== typeof c)
  ...
  var T = function(a, b, c) {
      ...
      if (!(d <= c.length && c.length <= e))
        throw (d === e
          ? ((b = d), (d = 1 === d ? "argument" : "arguments"))
          : ((b = "between " + d + " and " + e), (d = "arguments")),
        new v(
    ...
    me = function() {
      return new U(function(a) {
        if (!(("number" === typeof a || a instanceof Number) && 0 <= a))
          throw "Expected a number 0 or greater.";
      });
    },
    ne = function(a, b) {
      return new U(function(b) {
        if (!(null === b || (y(b) && b instanceof Object)))
  ...
  var pe = function(a) {
    ...
    ve = function(a, b, c) {
      ...
      c.size = b.a;
      c.contentType ||
        ((a = (b && b.type()) || "application/octet-stream"),
        (c.contentType = a));
      return c;
    },
      ...
      c = new w(
        ...
        function(a, c) {
          var f = ye(a, ["active", "final"]),
            ...
            O = d.a,
            x;
          "final" === f ? (x = qe(b, e)(a, c)) : (x = null);
          return new xe(m, O, "final" === f, x);
        },
        b.b
      );
      c.headers = f;
  ...
  var W = function(a, b, c, d, e, f) {
      ...
      this.V = function(a) {
        g.a = null;
        "storage/canceled" === a.code
          ? ((g.m = !0), Ce(g))
          : ((g.g = a), V(g, "error"));
      };
      this.Y = function(a) {
        g.a = null;
        "storage/canceled" === a.code ? Ce(g) : ((g.g = a), V(g, "error"));
      };
      this.w = this.l = null;
      this.F = new G(function(a, b) {
        g.l = a;
        g.w = b;
        De(g);
      });
  ...
  W.prototype.M = function(a, b, c, d) {
    ...
    T(
      ...
      [
        ke(function() {
          if ("state_changed" !== a)
            throw "Expected one of the event types: [state_changed].";
        }),
        ne(e, !0),
        oe(),
        oe()
  ...
  k.ra = function(a, b) {
    T("put", [le(), new U(ie, !0)], arguments);
    Qe(this, "put");
    return new W(this, this.b, this.a, fe(), new Q(a), b);
  };
  k.sa = function(a, b, c) {
    T("putString", [ke(), ke(Va, !0), new U(ie, !0)], arguments);
    Qe(this, "putString");
    var d = $a(y(b) ? b : "raw", a),
      e = c ? ta(c) : {};
  ...
  k.ta = function(a) {
    T("updateMetadata", [new U(ie, void 0)], arguments);
  ...
  k.xa = function(a) {
    T("setMaxUploadRetryTime", [me()], arguments);
    this.a.b = a;
  };
  k.za = function() {
    return this.a.c;
  ...
  k.wa = function(a) {
    T("setMaxOperationRetryTime", [me()], arguments);
    this.a.c = a;
  };
  k.la = function() {
    return this.b;
  ...
  (function() {
    ...
    if ("undefined" !== typeof firebase)
      firebase.INTERNAL.registerService("storage", a, b);
    else
      throw Error(
        "Cannot install Firebase Storage - be sure to load firebase-app.js first."
      );
  })();
})();
